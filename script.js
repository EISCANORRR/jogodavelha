...
function reiniciar() {
  ...
  function mudarTema1() {
      var mudar1 = document.getElementById('fundo');
      mudar1.style.backgroundColor = 'rgb(110, 110, 110)'
      var mudar2 = document.getElementById('t1');
      mudar2.style.color = 'white'
      var mudar3 = document.getElementById('t2');
      mudar3.style.color = 'white'
      var mudar4 = document.getElementById('t3');
      mudar4.style.color = 'white'
      var mudar5 = document.getElementById('t4');
      mudar5.style.color = 'black'
      var x = document.getElementById('geral')
      x.style.display = 'none'
  }
  function mudarTema2() {
    var mudar1 = document.getElementById('fundo');
    mudar1.style.backgroundColor = 'white'
    var mudar2 = document.getElementById('t1');
    mudar2.style.color = 'black'
    var mudar3 = document.getElementById('t2');
    mudar3.style.color = 'black'
    var mudar4 = document.getElementById('t3');
    mudar4.style.color = 'black'
    var mudar5 = document.getElementById('t4');
    mudar5.style.color = 'black'
    var x = document.getElementById('geral')
    x.style.display = 'none'
...
function mudarTema3() {
    var mudar1 = document.getElementById('fundo');
    mudar1.style.backgroundColor = 'blue'
    var mudar2 = document.getElementById('t1');
    mudar2.style.color = 'white'
    var mudar3 = document.getElementById('t2');
    mudar3.style.color = 'white'
